...
def final_plotting(nI,nJ,UVvec,U_norm,V_norm,xCoords_N,yCoords_N,U,V,P,data_file,residuals_U,residuals_V,residuals_c) -> None:
    # ============== Plotting =================
...
#@cuda.jit(cache=True)
#@cuda.jit
def rhieChow(aPe,aPw,aPn,aPs,rho,U,V,P,dx_CV,dy_CV,fxe,fxw,fyn,fys,coeffsUV,nI,nJ,Fe,Fw,Fn,Fs) -> None:
...
def main():
    ...
    for iter in range(nIterations):
        ...
        blockspergrid = (math.ceil(nI/32), math.ceil(nJ/32))
        #[Fe,Fw,Fn,Fs] = rhieChow(U,V,P,dx_CV,dy_CV,fxe,fxw,fyn,fys,coeffsUV,nI,nJ)    
        #rhieChow[blockspergrid, threadsperblock](aPe,aPw,aPn,aPs,U,V,P,dx_CV,dy_CV,fxe,fxw,fyn,fys,coeffsUV,nI,nJ,Fe,Fw,Fn,Fs)    
    ...
    final_plotting(nI,nJ,UVvec,U_norm,V_norm,xCoords_N,yCoords_N,U,V,P,data_file,residuals_U,residuals_V,residuals_c)
